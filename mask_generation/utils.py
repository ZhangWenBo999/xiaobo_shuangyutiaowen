...
strokes_configs = [
    'lama_generation/random_medium_256.yaml',
    'lama_generation/random_thick_256.yaml',
    'lama_generation/random_thin_256.yaml',
    'lama_generation/random_medium_512.yaml',
    'lama_generation/random_thick_512.yaml',
    'lama_generation/random_thin_512.yaml',
]
